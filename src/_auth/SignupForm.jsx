...
return (
    <div className="relative bg-default h-screen flex flex-col gap-4 items-center justify-center gap-x-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid w-full gap-4">
              ...
              <div className="text-center mt-4">
                <p>
                  Have an account? <Link to="/signin" className="text-blue-500 hover:text-blue-600">Log in</Link>
                </p>
              </div>
            </div>
          </form>
