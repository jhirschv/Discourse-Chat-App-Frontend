...
const Topbar = ({userInfo}) => {
  ...
  return (
    <div  className="fixed z-50 top-0 w-full h-12 lg:h-0 flex items-center justify-between p-3 pt-4 pb-4 lg:py-8 bg-background ">
        <div className='flex font-bold text-3xl ml-4 text-primary'><NavLink to='/home'><h1 >Discourse</h1></NavLink></div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className='ml-10 mr-4' size="icon">
              <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
              <Moon className="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
              <span className="sr-only">Toggle theme</span>
            </Button>
